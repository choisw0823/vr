...
model = dict(
    ...
    audio_encoder=dict(
        name='beats',
        d_model=768,
        audio_model_path="/home/work/smoretalk/seo/reranking/new_d/InternVideo2-Stage2_6B-224p-f4/internvideo2-s2_6b-224p-f4_with_audio_encoder.pt",
    ),
    vision_encoder=dict(
        # backbone
        ...
        pretrained='/home/work/smoretalk/seo/reranking/new_d/InternVideo2-Stage2_6B-224p-f4/internvideo2-s2_6b-224p-f4_with_audio_encoder.pt',
        use_checkpoint=True,
        checkpoint_num=48,
        use_flash_attn=flag,
