...
def main(config):
    ...
    print(f"\033[31m CURRENT NODE NAME: {os.environ.get('SLURMD_NODENAME', 'N/A')} dataloader is OK {datetime.datetime.now().strftime('%Y-%m-%d-%H_%M_%S')}!!! \033[0m")
...
if __name__ == "__main__":
    print(f"\033[31m NODE LIST: {os.environ.get('SLURM_NODELIST', 'N/A')} \033[0m")
    logger.info(f"NODE LIST: {os.environ.get('SLURM_NODELIST', 'N/A')}")
    cfg = setup_main()
