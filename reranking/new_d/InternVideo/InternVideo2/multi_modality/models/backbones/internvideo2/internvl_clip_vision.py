...
try:
    ...
    DROPOUT_RMS_NORM_AVAILABLE = True
except:
    DropoutAddRMSNorm = None
    DROPOUT_RMS_NORM_AVAILABLE = False
...
class Block(nn.Module):
    ...
    def __init__(
        ...
        if use_fused_mlp and FUSED_MLP_AVAILABLE:
...
class InternVL_CLIP(nn.Module):
    def __init__(
        ...
        if use_fused_rmsnorm and DROPOUT_RMS_NORM_AVAILABLE:
